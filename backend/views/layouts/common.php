    ...
    <section class="sidebar">
      ...
      <?php echo Menu::widget([
        ...
        'items' => [
          ...
          [
            'label' => Yii::t('common', 'Album'),
            'url' => '#',
            'icon' => '<i class="fa fa-image"></i>',
            'options' => ['class' => 'treeview'],
            'items' => [
              ['label' => Yii::t('common', 'Album Category'), 'url' => ['/album-category/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
              ['label' => Yii::t('common', 'Album'), 'url' => ['/album/index'], 'icon' => '<i class="fa fa-angle-double-right"></i>'],
            ]
          ],
